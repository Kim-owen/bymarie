...
function footer() {
  return `
    <footer>
      <div class="brand"><span>B</span>ByMarie</div>
      ...
      <div class="auth-page-card">
        ...
        <div class="auth-showcase-side">
          ...
          <div class="auth-showcase-content">
            <a class="brand auth-brand" href="#home" onclick="go('home')"><span>B</span>ByMarie</a>
  ...
  return `
    <main class="admin-shell">
      <aside class="admin-sidebar">
        <a class="brand admin-brand" href="#home" onclick="go('home')"><span>B</span>ByMarie</a>
